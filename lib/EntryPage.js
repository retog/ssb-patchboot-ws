module.exports.EntryPage = class EntryPage {
  ...
  <head>
    ...
    <meta http-equiv="Content-Security-Policy" content="default-src 'self' data: ws://${hostName}:8989/; style-src 'self' 'unsafe-inline'; script-src 'self' 'unsafe-eval' 'unsafe-inline'">
